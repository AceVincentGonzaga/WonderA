...
public class TouristHotSpotRegistration extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            context = TouristHotSpotRegistration.this;
            ...
            selectBType(Utils.bTypeHotSpots);
            categories.add("Restaurant");
            categories.add("Accomodation");
            categories.add("Gifting Center");
            categories.add(Utils.bTypeHotSpots);
            ...
            showLast();
            if (ContextCompat.checkSelfPermission(TouristHotSpotRegistration.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(TouristHotSpotRegistration.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_ID);
                return;
            }
        ...
        private void selectBusinessTypeDialog(){
            final Dialog dialog = new Dialog(TouristHotSpotRegistration.this);
...
//                ImageBannerOldURL = bannerUri;
    ...
    private void setImage(Uri uri, ImageView imageView){
        ...
        bannerUri = uri;
        imageSet = true;
        Glide.with(TouristHotSpotRegistration.this).load(uri).into(imageView);
