...
import com.wandera.wanderaowner.activity.AccomodationsRegistration;
...
public class GiftingCenterRegistration extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            context = GiftingCenterRegistration.this;
            ...
            selectBType("Gifting Center");
            categories.add("Restaurant");
            categories.add("Accomodation");
            categories.add("Gifting Center");
            ...
            showLast();
            if (ContextCompat.checkSelfPermission(GiftingCenterRegistration.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(GiftingCenterRegistration.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_ID);
                return;
            }
        ...
        private void selectBusinessTypeDialog(){
            final Dialog dialog = new Dialog(GiftingCenterRegistration.this);
...
//                ImageBannerOldURL = bannerUri;
    ...
    private void setImage(Uri uri, ImageView imageView){
        ...
        bannerUri = uri;
        imageSet = true;
        Glide.with(GiftingCenterRegistration.this).load(uri).into(imageView);
    ...
    private void selectMunicipality(){
        ...
        FirebaseDatabase.getInstance().getReference().child("municipality").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(GiftingCenterRegistration.this);
