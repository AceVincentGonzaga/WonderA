...
public class AddMenuGiftingActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        context = AddMenuGiftingActivity.this;
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("gifting").child("category").child(businesskey).child(categoryKey).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                CategoryMapModel categoryMapModel = dataSnapshot.getValue(CategoryMapModel.class);
                categoryName.setText(categoryMapModel.category);
            }
...
//                ImageBannerOldURL = bannerUri;
    ...
    private void setImage(Uri uri, ImageView imageView){
        ...
        bannerUri = uri;
        imageSet = true;
        Glide.with(AddMenuGiftingActivity.this).load(uri).into(imageView);
...
//                        uploadProgress.setText("Uploading " +taskSnapshot.getBytesTransferred()+" of "+file.available()+" "+progress+" %");
    ...
    private void saveMenu(String menuName,int menuPrice,String menuImagePath){
        String key = mDatabase.child("gifting").child("menus").child(businesskey).push().getKey();
