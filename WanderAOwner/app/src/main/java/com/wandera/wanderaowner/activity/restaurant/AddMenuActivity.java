...
public class AddMenuActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        mDatabase.child("restaurant").child("category").child(businesskey).child(categoryKey).addValueEventListener(new ValueEventListener() {
            @Override
...
//                ImageBannerOldURL = bannerUri;
    ...
    private void setImage(Uri uri, ImageView imageView){
        ...
        bannerUri = uri;
        imageSet = true;
        Glide.with(AddMenuActivity.this).load(uri).into(imageView);
