...
public class AccomodationsRegistration extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            context = AccomodationsRegistration.this;
            ...
            showLast();
            if (ContextCompat.checkSelfPermission(AccomodationsRegistration.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(AccomodationsRegistration.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_PERMISSION_ID);
                return;
            }
...
//                ImageBannerOldURL = bannerUri;
    ...
    private void setImage(Uri uri, ImageView imageView){
        ...
        bannerUri = uri;
        imageSet = true;
        Glide.with(AccomodationsRegistration.this).load(uri).into(imageView);
