...
public class OwernerRegistration extends AppCompatActivity implements OnLocationUpdatedListener, OnActivityUpdatedListener, OnGeofencingTransitionListener {
    ...
    private void selectBusinessTypeDialog(){
        ...
        final TextView selectResto = (TextView) dialog.findViewById(R.id.selectResto);
        final TextView selectAccomodation = (TextView) dialog.findViewById(R.id.selectAccomodation);
        final TextView selectPasalubongCenter = (TextView) dialog.findViewById(R.id.pasalubongCenter);
        final TextView selectTouristSpots = (TextView) dialog.findViewById(R.id.touristSpots);
        selectResto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectBType(selectResto.getText().toString());
                dialog.dismiss();
            }
        });
        selectAccomodation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectBType(selectBType.getText().toString());
                dialog.dismiss();
            }
        });
        selectPasalubongCenter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectBType(selectPasalubongCenter.getText().toString());
                dialog.dismiss();
            }
        });
        selectTouristSpots.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectBType(selectTouristSpots.getText().toString());
                dialog.dismiss();
            }
        });
        dialog.show();
    ...
    private boolean validate(){
        ...
        if(inpt_email.getText().length()==0){
            val = false;
        }
        return val;
    }
