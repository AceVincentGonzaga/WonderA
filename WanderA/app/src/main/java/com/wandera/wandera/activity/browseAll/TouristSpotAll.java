...
public class TouristSpotAll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("businessProfiles").orderByChild("businessType").equalTo(Utils.bTypeHotSpots).addValueEventListener(new ValueEventListener() {
            @Override
