package com.wandera.wandera.views.giftingProfile;
...
import com.wandera.wandera.views.RestuarantMenusRecyclerViewAdapter;
...
public class GiftingCategoryRecyclerViewAdapter
    ...
    public GiftingCategoryRecyclerViewAdapter(Context c, ArrayList<RestaurantMenuCategoryDataModel> restaurantMenuCategoryDataModels){
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        FirebaseDatabase.getInstance().getReference().child(Utils.GIFT_DIR)
