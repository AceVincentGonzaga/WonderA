...
public class GiftingAll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("businessProfiles").orderByChild("businessType").equalTo("Gifting Center").addValueEventListener(new ValueEventListener() {
            @Override
